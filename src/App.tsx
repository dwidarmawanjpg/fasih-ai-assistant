...
5. KHUSUS KATEGORI "Aset": JANGAN pisahkan jumlah dan harga. Gabungkan dalam bentuk Teks (contoh value: "2 Unit = Rp 30.000.000").
   ...
   - Emas: Asumsi Rp 1.000.000 per gram.
...
`;
  ...
  return (
    <div className="layout-container">
      {/* Sidebar History */}
      <aside className="sidebar" aria-label="Riwayat Obrolan">
        <button className="new-chat-btn" onClick={createNewSession} aria-label="Buat ekstraksi baru">
